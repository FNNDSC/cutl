        ...
        */
        duplicateMultipleFeeds = async function(feedIdList, newFeedName){
           ...
           if(feedIdList.length==1){
             ...
             // create dircopy params
             const dircopyParams = {dir:swiftPath.toString(), previous_id: 0, title: newFeedName};
             ...
             for(const feedId of feedIdList){
               ...
               // create dircopy params
               dircopyParams = {dir:swiftPath.toString(), previous_id: 0, title: newFeedName+feed.data.name};
               
               // schedule dircopy
               response = await this.client.createPluginInstance(dircopyId,dircopyParams);
